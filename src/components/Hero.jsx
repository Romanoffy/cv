...
import { profilePic, andra } from "../assets";
...
const Hero = () => {
  const counters = [
    ...
    { value: 20, suffix: "+", label: "Code Commits" },
  ];
    ...
    <>
      ...
      >
        <div className="flex-1 flex flex-col justify-start px-4 sm:px-8 lg:px-10">
          ...
          >
            My name is{" "}
            <span className="text-teal-500 font-bold">Andra Alfairuz</span>. I am a student majoring in software and game development at a vocational high school, with a great interest in creating innovative digital solutions. I aspire to develop applications or websites that can help businesses or products to develop through efficient management, creative publications, strategic marketing and effective promotions. With experience in developing various web-based projects, I continue to learn to strengthen my technical and creative abilities to make a real impact in the world of technology. With experience
            in{" "}
        ...
        <div className="flex flex-col justify-center items-center relative mt-8 md:mt-0 mr-30">
          <div className="overflow-hidden border-4 border-teal-500 w-52 h-52 sm:w-40 sm:h-40 md:w-48 md:h-48 lg:w-56 lg:h-56 mr-30">
            <img
              src={andra}
              alt="Andra Alfairuz"
