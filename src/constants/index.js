...
export const callToAction = "https://www.instagram.com/verdenjeann/";
...
export const educationList = [
  {
    id: "education-1",
    icon: smk,
    title: "SMK Prakarya Internasional",
    degree: "Software and Game Development Major",
    duration: "2023 - Precent",
    content1: "Major: Software and Game Development",
...
export const achievements = [
  {
    ...
    event: "Lorem Ipsum",
    position: "4.0/4.0 ",
    content1: "Top Position",
    content2: "Class Representative",
...
export const experiences = [
  {
    organisation: "SMK Prakarya Internasional",
    logo: smk,
    ...
    positions: [
      {
        ...
        content: [
          {
            text: "➾ Learn many programming languages, create projects in various programming languages ​​such as HTML, CSS, Javascript, and PHP, also know how logic and algorithms work in this field.",
            link: "",
          },
          // {
...
export const projects = [
  ...
  // },
  {
    id: "project-10",
    title: "Portfolio",
    github: "https://github.com/Romanoffy/cv",
    link: "https://cv-zeta-puce.vercel.app",
...
export const extraCurricular = [
  {
    id: 1,
    organisation: "Lorem Ipsum",
    title: "Professional Career ",
    duration: "March 2024 - May 2024",
    content: [
      {
        text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla ultricies ex ac viverra finibus. Donec lacinia iaculis massa ac porttitor. Aliquam sed lorem sed quam condimentum porttitor ut id eros..",
      },
      // {
...
export const socialMedia = [
  ...
  // },
  {
    id: "social-media-2",
    icon: AiFillGithub,
    link: "https://github.com/Romanoffy",
  },
  {
    id: "social-media-3",
    icon: AiFillMail,
    link: "mailto:namanyaxalf@gmail.com",
  },
  {
    id: "social-media-4",
    icon: SiInstagram,
    link: "https://www.instagram.com/verdenjeann/",
  },
  // {
  //   id: "social-media-5",
  //   icon: FaMedium,
...
`,
  intro: "Junior Software Developer from Indonesia who are studying and want to know more in this field."
}
